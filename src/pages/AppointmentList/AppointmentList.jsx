      ...
      {haveAppointment ? (
        <div>
          ...
          <AppointmentItem svPackage="Khám định kỳ cho Chó Aslaska" status="Đã nhận" name="Dương Quang Quốc"
            ...
            Khuê, Đà Nẵng Q. Thanh Khuê, Đà Nẵng Q. Thanh Khuê, Đà Nẵng" appointmentDate="25/09/2023" appointmentTime="9:30 AM" clinicAddress="Thú y sông Hàn - CS1:
        ...
        <div className="w-full h-[75%] flex justify-center items-center flex-col">
          ...
          <p className="text-gray-400">Hiện tại bạn chưa có lịch nào nào với bác sĩ, hãy đặt lịch ngay vì sức khỏe của
            thú cưng</p>
