    ...
    <div className="w-[60%] h-fit bg-white py-9 px-8 shadow-2xl mr-36">
      ...
      <form className="grid grid-cols-1 gap-x-9 gap-y-4">
        <div className="flex flex-col relative px-6">
          ...
          <input type={hiddenOldPass ? "password" : "text"} placeholder="" className="w-full px-5 py-2 rounded-sm bg-inputColor focus:outline-primaryColor hover:bg-gray-200"
        ...
        <div className="flex flex-col relative px-6">
          ...
          <input type={hiddenNewPass ? "password" : "text"} placeholder="" className="w-full px-5 py-2 rounded-sm bg-inputColor focus:outline-primaryColor hover:bg-gray-200"
        ...
        <div className="flex flex-col relative px-6">
          ...
          <input type={hiddenCfPass ? "password" : "text"} placeholder="" className="w-full px-5 py-2 rounded-sm bg-inputColor focus:outline-primaryColor hover:bg-gray-200"
