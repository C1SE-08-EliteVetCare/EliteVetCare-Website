      ...
      <div
        ...
        <div className="text-center lg:col-span-4">
          <div className="w-[70%] m-auto">
            ...
            <h1 className="text-base font-normal">Vui lòng nhập địa chỉ email đã đăng ký của bạn. Bạn sẽ nhận được mã OTP để tạo mật khẩu mới</h1>
            <form action="" className="mt-9">
              ...
              <button className="bg-primaryColor text-white w-full py-3 mb-4 rounded-3xl hover:bg-blue-600">Gửi</button>
            </form>
            <div className="mb-10">
