              ...
              <div className="px-6 py-6 lg:px-8">
                <form action="#" className="flex justify-between items-center">
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-start mb-2 text-sm font-medium text-gray-900">Loài</label>
                      <input type="text" placeholder=""
                             className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                             required />
                    </div>
                    <div>
                      <label className="block text-start mb-2 text-sm font-medium text-gray-900">Giống</label>
                      <input type="text"
                             className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                             placeholder="" required />
                    </div>
                    <div>
                      <label className="block text-start mb-2 text-sm font-medium text-gray-900">Tuổi</label>
                      <input type="text" placeholder=""
                             className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                             required />
                    </div>
                    ...
                    <div className="">
                      <label className="block text-start mb-2 text-sm font-medium text-gray-900">Cân nặng</label>
                      <input type="text" placeholder=""
                             className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                             required />
                    </div>
                  ...
                  <div className="">
                    ...
                    <div className="relative">
                      <img className="w-[275px] h-72 object-cover rounded-2xl mb-6 hover:blur-sm hover:cursor-pointer"
                           src="https://ph-files.imgix.net/75c2cda9-e2c3-4bcd-a0b1-0595daba1844.png?auto=format&fit=crop"
                           alt="anh thu cung" onClick={() => avaterRef.current.click()}
                      />
                      <FontAwesomeIcon className="absolute top-[50%] text-2xl text-primaryColor" icon={faEdit}
