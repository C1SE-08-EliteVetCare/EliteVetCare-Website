    ...
    <main className="container max-w-screen-xl mx-auto mt-8">
      <div className="relative h-[500px] mt-10 mb-16 p-4 bg-[#E8F0FA] rounded-xl">
        ...
        <div className="absolute left-[28%] top-[30%] w-[40%]">
          ...
          <p className="text-xl font-normal leading-snug mb-2">Dịch vụ phòng khám thú y tại Đà Nẵng - Nơi chúng tôi yêu
     ...
     <CommitmentItem/>
      ...
      <div className="relative h-[350px] mt-10 mb-16 drop-shadow-2xl bg-[#E8F0FA] p-4 rounded-2xl">
        ...
        <div className="absolute right-[4%] top-[40%] w-[40%] text-end">
          ...
          <p className="text-xl font-medium leading-4 mb-2">Đội ngủ bác sĩ chuyên nghiệp và trang thiết bị hiện đại</p>
