...
const AppointmentItem = ({svPackage, status, name, phone,address,appointmentDate, appointmentTime, clinicAddress}) => {
    return (
        <div>
            <div className="w-full shadow-md mt-6 py-3 px-6 mb-2">
                ...
                <div className="grid grid-cols-3 text-start gap-y-2 p-2">
                    ...
                    <p className="col-span-3"><span className="font-medium">Địa chỉ phòng khám:</span> {clinicAddress}
                    </p>
                </div>
            </div>
            <div className="w-full shadow-md mt-6 py-3 px-6 mb-2">
